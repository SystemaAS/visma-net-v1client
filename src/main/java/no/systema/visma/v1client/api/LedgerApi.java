...
@Component("no.systema.visma.v1client.api.LedgerApi")
public class LedgerApi {
     ...
     */
    public List<LedgerDto> ledgerGetAllLedgers(String greaterThanValue, Integer numberToRead, Integer skipRecords, String orderBy, String lastModifiedDateTime, String lastModifiedDateTimeCondition) throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/controller/api/v1/ledger").build().toUriString();
        ...
        ParameterizedTypeReference<List<LedgerDto>> returnType = new ParameterizedTypeReference<List<LedgerDto>>() {};
