...
public class CashSaleLinesUpdateDto {
  ...
  public CashSaleLinesUpdateDto operation(OperationEnum operation) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto inventoryNumber(DtoValueString inventoryNumber) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto lineNumber(DtoValueInt32 lineNumber) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto description(DtoValueString description) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto quantity(DtoValueDecimal quantity) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto unitPriceInCurrency(DtoValueDecimal unitPriceInCurrency) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto manualAmountInCurrency(DtoValueDecimal manualAmountInCurrency) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto accountNumber(DtoValueString accountNumber) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto vatCodeId(DtoValueString vatCodeId) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto uom(DtoValueString uom) {
    this.uom = uom;
    return this;
  }
  ...
  **/
  ...
  public CashSaleLinesUpdateDto discountPercent(DtoValueDecimal discountPercent) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto discountAmountInCurrency(DtoValueDecimal discountAmountInCurrency) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto manualDiscount(DtoValueBoolean manualDiscount) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto subaccount(List<SegmentUpdateDto> subaccount) {
    this.subaccount = subaccount;
    return this;
  }

  public CashSaleLinesUpdateDto addSubaccountItem(SegmentUpdateDto subaccountItem) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto salesperson(DtoValueString salesperson) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto deferralSchedule(DtoValueInt32 deferralSchedule) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto deferralCode(DtoValueString deferralCode) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto termStartDate(DtoValueDateTime termStartDate) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto termEndDate(DtoValueDateTime termEndDate) {
  ...
  **/
  ...
  public CashSaleLinesUpdateDto note(DtoValueString note) {
    this.note = note;
    return this;
  }
  ...
  **/
  ...
  public CashSaleLinesUpdateDto branchNumber(DtoValueString branchNumber) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CashSaleLinesUpdateDto cashSaleLinesUpdateDto = (CashSaleLinesUpdateDto) o;
    return Objects.equals(this.operation, cashSaleLinesUpdateDto.operation) &&
        Objects.equals(this.inventoryNumber, cashSaleLinesUpdateDto.inventoryNumber) &&
        Objects.equals(this.lineNumber, cashSaleLinesUpdateDto.lineNumber) &&
        Objects.equals(this.description, cashSaleLinesUpdateDto.description) &&
        Objects.equals(this.quantity, cashSaleLinesUpdateDto.quantity) &&
        Objects.equals(this.unitPriceInCurrency, cashSaleLinesUpdateDto.unitPriceInCurrency) &&
        Objects.equals(this.manualAmountInCurrency, cashSaleLinesUpdateDto.manualAmountInCurrency) &&
        Objects.equals(this.accountNumber, cashSaleLinesUpdateDto.accountNumber) &&
        Objects.equals(this.vatCodeId, cashSaleLinesUpdateDto.vatCodeId) &&
        Objects.equals(this.uom, cashSaleLinesUpdateDto.uom) &&
        Objects.equals(this.discountPercent, cashSaleLinesUpdateDto.discountPercent) &&
        Objects.equals(this.discountAmountInCurrency, cashSaleLinesUpdateDto.discountAmountInCurrency) &&
        Objects.equals(this.manualDiscount, cashSaleLinesUpdateDto.manualDiscount) &&
        Objects.equals(this.subaccount, cashSaleLinesUpdateDto.subaccount) &&
        Objects.equals(this.salesperson, cashSaleLinesUpdateDto.salesperson) &&
        Objects.equals(this.deferralSchedule, cashSaleLinesUpdateDto.deferralSchedule) &&
        Objects.equals(this.deferralCode, cashSaleLinesUpdateDto.deferralCode) &&
        Objects.equals(this.termStartDate, cashSaleLinesUpdateDto.termStartDate) &&
        Objects.equals(this.termEndDate, cashSaleLinesUpdateDto.termEndDate) &&
        Objects.equals(this.note, cashSaleLinesUpdateDto.note) &&
        Objects.equals(this.branchNumber, cashSaleLinesUpdateDto.branchNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(operation, inventoryNumber, lineNumber, description, quantity, unitPriceInCurrency, manualAmountInCurrency, accountNumber, vatCodeId, uom, discountPercent, discountAmountInCurrency, manualDiscount, subaccount, salesperson, deferralSchedule, deferralCode, termStartDate, termEndDate, note, branchNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class CashSaleLinesUpdateDto {\n");
