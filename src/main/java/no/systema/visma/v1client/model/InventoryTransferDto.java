...
import no.systema.visma.v1client.model.InventoryTransferLineDto;
...
public class InventoryTransferDto {
  ...
  private List<InventoryTransferLineDto> transferLines = null;
  ...
  public InventoryTransferDto warehouse(WarehouseIdDescriptionDto warehouse) {
  ...
  **/
  ...
  public InventoryTransferDto toWarehouse(WarehouseIdDescriptionDto toWarehouse) {
  ...
  **/
  ...
  public InventoryTransferDto transferLines(List<InventoryTransferLineDto> transferLines) {
    this.transferLines = transferLines;
    return this;
  }

  public InventoryTransferDto addTransferLinesItem(InventoryTransferLineDto transferLinesItem) {
  ...
  **/
  @ApiModelProperty(value = "The inventory transfer lines")
  public List<InventoryTransferLineDto> getTransferLines() {
    return transferLines;
  }

  public void setTransferLines(List<InventoryTransferLineDto> transferLines) {
    this.transferLines = transferLines;
  }

  public InventoryTransferDto referenceNumber(String referenceNumber) {
  ...
  **/
  ...
  public InventoryTransferDto status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InventoryTransferDto hold(Boolean hold) {
    this.hold = hold;
    return this;
  }
  ...
  **/
  ...
  public InventoryTransferDto date(LocalDateTime date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public InventoryTransferDto postPeriod(String postPeriod) {
  ...
  **/
  ...
  public InventoryTransferDto externalReference(String externalReference) {
  ...
  **/
  ...
  public InventoryTransferDto description(String description) {
  ...
  **/
  ...
  public InventoryTransferDto totalQuantity(Double totalQuantity) {
  ...
  **/
  ...
  public InventoryTransferDto controlQuantity(Double controlQuantity) {
  ...
  **/
  ...
  public InventoryTransferDto batchNumber(String batchNumber) {
  ...
  **/
  ...
  public InventoryTransferDto lastModifiedDateTime(LocalDateTime lastModifiedDateTime) {
  ...
  **/
  ...
  public InventoryTransferDto branchNumber(BranchNumberDto branchNumber) {
  ...
  **/
  ...
  public InventoryTransferDto attachments(List<AttachmentDto> attachments) {
    this.attachments = attachments;
    return this;
  }

  public InventoryTransferDto addAttachmentsItem(AttachmentDto attachmentsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InventoryTransferDto inventoryTransferDto = (InventoryTransferDto) o;
    return Objects.equals(this.warehouse, inventoryTransferDto.warehouse) &&
        Objects.equals(this.toWarehouse, inventoryTransferDto.toWarehouse) &&
        Objects.equals(this.transferLines, inventoryTransferDto.transferLines) &&
        Objects.equals(this.referenceNumber, inventoryTransferDto.referenceNumber) &&
        Objects.equals(this.status, inventoryTransferDto.status) &&
        Objects.equals(this.hold, inventoryTransferDto.hold) &&
        Objects.equals(this.date, inventoryTransferDto.date) &&
        Objects.equals(this.postPeriod, inventoryTransferDto.postPeriod) &&
        Objects.equals(this.externalReference, inventoryTransferDto.externalReference) &&
        Objects.equals(this.description, inventoryTransferDto.description) &&
        Objects.equals(this.totalQuantity, inventoryTransferDto.totalQuantity) &&
        Objects.equals(this.controlQuantity, inventoryTransferDto.controlQuantity) &&
        Objects.equals(this.batchNumber, inventoryTransferDto.batchNumber) &&
        Objects.equals(this.lastModifiedDateTime, inventoryTransferDto.lastModifiedDateTime) &&
        Objects.equals(this.branchNumber, inventoryTransferDto.branchNumber) &&
        Objects.equals(this.attachments, inventoryTransferDto.attachments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(warehouse, toWarehouse, transferLines, referenceNumber, status, hold, date, postPeriod, externalReference, description, totalQuantity, controlQuantity, batchNumber, lastModifiedDateTime, branchNumber, attachments);
  }
  ...
  public String toString() {
    ...
    sb.append("class InventoryTransferDto {\n");
