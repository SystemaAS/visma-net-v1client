...
import no.systema.visma.v1client.model.CreditNoteLineDto;
...
public class CreditNoteDto {
  ...
  private List<CreditNoteLineDto> invoiceLines = null;
  ...
  public CreditNoteDto externalReference(String externalReference) {
  ...
  **/
  ...
  public CreditNoteDto contact(ContactIdNameDto contact) {
  ...
  **/
  ...
  public CreditNoteDto attachments(List<AttachmentDto> attachments) {
    this.attachments = attachments;
    return this;
  }

  public CreditNoteDto addAttachmentsItem(AttachmentDto attachmentsItem) {
  ...
  **/
  ...
  public CreditNoteDto invoiceLines(List<CreditNoteLineDto> invoiceLines) {
    this.invoiceLines = invoiceLines;
    return this;
  }

  public CreditNoteDto addInvoiceLinesItem(CreditNoteLineDto invoiceLinesItem) {
  ...
  **/
  ...
  public void setInvoiceLines(List<CreditNoteLineDto> invoiceLines) {
    this.invoiceLines = invoiceLines;
  }

  public CreditNoteDto hold(Boolean hold) {
    this.hold = hold;
    return this;
  }
  ...
  **/
  ...
  public CreditNoteDto detailTotal(Double detailTotal) {
  ...
  **/
  ...
  public CreditNoteDto detailTotalInCurrency(Double detailTotalInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto vatTaxableTotal(Double vatTaxableTotal) {
  ...
  **/
  ...
  public CreditNoteDto vatTaxableTotalInCurrency(Double vatTaxableTotalInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto vatExemptTotal(Double vatExemptTotal) {
  ...
  **/
  ...
  public CreditNoteDto vatExemptTotalInCurrency(Double vatExemptTotalInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto salesPersonID(Integer salesPersonID) {
  ...
  **/
  ...
  public CreditNoteDto salesPersonDescr(String salesPersonDescr) {
  ...
  **/
  ...
  public CreditNoteDto paymentReference(String paymentReference) {
  ...
  **/
  ...
  public CreditNoteDto customer(CustomerNumberDto customer) {
  ...
  **/
  ...
  public CreditNoteDto documentType(DocumentTypeEnum documentType) {
  ...
  **/
  ...
  public CreditNoteDto referenceNumber(String referenceNumber) {
  ...
  **/
  ...
  public CreditNoteDto postPeriod(String postPeriod) {
  ...
  **/
  ...
  public CreditNoteDto financialPeriod(String financialPeriod) {
  ...
  **/
  ...
  public CreditNoteDto closedFinancialPeriod(String closedFinancialPeriod) {
  ...
  **/
  ...
  public CreditNoteDto documentDate(LocalDateTime documentDate) {
  ...
  **/
  ...
  public CreditNoteDto status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CreditNoteDto currencyId(String currencyId) {
  ...
  **/
  ...
  public CreditNoteDto amount(Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public CreditNoteDto amountInCurrency(Double amountInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto balance(Double balance) {
  ...
  **/
  ...
  public CreditNoteDto balanceInCurrency(Double balanceInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto cashDiscount(Double cashDiscount) {
  ...
  **/
  ...
  public CreditNoteDto cashDiscountInCurrency(Double cashDiscountInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto paymentMethod(PaymentMethodIdDescriptionDto paymentMethod) {
  ...
  **/
  ...
  public CreditNoteDto customerRefNumber(String customerRefNumber) {
  ...
  **/
  ...
  public CreditNoteDto invoiceText(String invoiceText) {
  ...
  **/
  ...
  public CreditNoteDto lastModifiedDateTime(LocalDateTime lastModifiedDateTime) {
  ...
  **/
  ...
  public CreditNoteDto createdDateTime(LocalDateTime createdDateTime) {
  ...
  **/
  ...
  public CreditNoteDto note(String note) {
    this.note = note;
    return this;
  }
  ...
  **/
  ...
  public CreditNoteDto vatTotal(Double vatTotal) {
  ...
  **/
  ...
  public CreditNoteDto vatTotalInCurrency(Double vatTotalInCurrency) {
  ...
  **/
  ...
  public CreditNoteDto location(LocationDescriptionDto location) {
  ...
  **/
  ...
  public CreditNoteDto branchNumber(BranchNumberDto branchNumber) {
  ...
  **/
  ...
  public CreditNoteDto cashAccount(String cashAccount) {
  ...
  **/
  ...
  public CreditNoteDto project(ProjectIdDescriptionDto project) {
  ...
  **/
  ...
  public CreditNoteDto account(AccountNumberDto account) {
  ...
  **/
  ...
  public CreditNoteDto subaccount(SubAccountDto subaccount) {
  ...
  **/
  ...
  public CreditNoteDto extras(Map<String, Object> extras) {
    this.extras = extras;
    return this;
  }

  public CreditNoteDto putExtrasItem(String key, Object extrasItem) {
    if (this.extras == null) {
  ...
  **/
  ...
  public CreditNoteDto errorInfo(String errorInfo) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.externalReference, creditNoteDto.externalReference) &&
        Objects.equals(this.contact, creditNoteDto.contact) &&
        Objects.equals(this.attachments, creditNoteDto.attachments) &&
        Objects.equals(this.invoiceLines, creditNoteDto.invoiceLines) &&
        Objects.equals(this.hold, creditNoteDto.hold) &&
        Objects.equals(this.detailTotal, creditNoteDto.detailTotal) &&
        Objects.equals(this.detailTotalInCurrency, creditNoteDto.detailTotalInCurrency) &&
        Objects.equals(this.vatTaxableTotal, creditNoteDto.vatTaxableTotal) &&
        Objects.equals(this.vatTaxableTotalInCurrency, creditNoteDto.vatTaxableTotalInCurrency) &&
        Objects.equals(this.vatExemptTotal, creditNoteDto.vatExemptTotal) &&
        Objects.equals(this.vatExemptTotalInCurrency, creditNoteDto.vatExemptTotalInCurrency) &&
        Objects.equals(this.salesPersonID, creditNoteDto.salesPersonID) &&
        Objects.equals(this.salesPersonDescr, creditNoteDto.salesPersonDescr) &&
        Objects.equals(this.paymentReference, creditNoteDto.paymentReference) &&
        Objects.equals(this.customer, creditNoteDto.customer) &&
        Objects.equals(this.documentType, creditNoteDto.documentType) &&
        Objects.equals(this.referenceNumber, creditNoteDto.referenceNumber) &&
        Objects.equals(this.postPeriod, creditNoteDto.postPeriod) &&
        Objects.equals(this.financialPeriod, creditNoteDto.financialPeriod) &&
        Objects.equals(this.closedFinancialPeriod, creditNoteDto.closedFinancialPeriod) &&
        Objects.equals(this.documentDate, creditNoteDto.documentDate) &&
        Objects.equals(this.status, creditNoteDto.status) &&
        Objects.equals(this.currencyId, creditNoteDto.currencyId) &&
        Objects.equals(this.amount, creditNoteDto.amount) &&
        Objects.equals(this.amountInCurrency, creditNoteDto.amountInCurrency) &&
        Objects.equals(this.balance, creditNoteDto.balance) &&
        Objects.equals(this.balanceInCurrency, creditNoteDto.balanceInCurrency) &&
        Objects.equals(this.cashDiscount, creditNoteDto.cashDiscount) &&
        Objects.equals(this.cashDiscountInCurrency, creditNoteDto.cashDiscountInCurrency) &&
        Objects.equals(this.paymentMethod, creditNoteDto.paymentMethod) &&
        Objects.equals(this.customerRefNumber, creditNoteDto.customerRefNumber) &&
        Objects.equals(this.invoiceText, creditNoteDto.invoiceText) &&
        Objects.equals(this.lastModifiedDateTime, creditNoteDto.lastModifiedDateTime) &&
        Objects.equals(this.createdDateTime, creditNoteDto.createdDateTime) &&
        Objects.equals(this.note, creditNoteDto.note) &&
        Objects.equals(this.vatTotal, creditNoteDto.vatTotal) &&
        Objects.equals(this.vatTotalInCurrency, creditNoteDto.vatTotalInCurrency) &&
        Objects.equals(this.location, creditNoteDto.location) &&
        Objects.equals(this.branchNumber, creditNoteDto.branchNumber) &&
        Objects.equals(this.cashAccount, creditNoteDto.cashAccount) &&
        Objects.equals(this.project, creditNoteDto.project) &&
        Objects.equals(this.account, creditNoteDto.account) &&
        Objects.equals(this.subaccount, creditNoteDto.subaccount) &&
        Objects.equals(this.extras, creditNoteDto.extras) &&
        Objects.equals(this.errorInfo, creditNoteDto.errorInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalReference, contact, attachments, invoiceLines, hold, detailTotal, detailTotalInCurrency, vatTaxableTotal, vatTaxableTotalInCurrency, vatExemptTotal, vatExemptTotalInCurrency, salesPersonID, salesPersonDescr, paymentReference, customer, documentType, referenceNumber, postPeriod, financialPeriod, closedFinancialPeriod, documentDate, status, currencyId, amount, amountInCurrency, balance, balanceInCurrency, cashDiscount, cashDiscountInCurrency, paymentMethod, customerRefNumber, invoiceText, lastModifiedDateTime, createdDateTime, note, vatTotal, vatTotalInCurrency, location, branchNumber, cashAccount, project, account, subaccount, extras, errorInfo);
  }
