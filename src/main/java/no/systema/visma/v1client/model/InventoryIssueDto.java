...
import no.systema.visma.v1client.model.InventoryIssueLineDto;
...
public class InventoryIssueDto {
  ...
  private Double controlAmount = null;

  @JsonProperty("issueLines")
  private List<InventoryIssueLineDto> issueLines = null;
  ...
  public InventoryIssueDto totalAmount(Double totalAmount) {
   ...
   * @return totalAmount
  **/
  @ApiModelProperty(value = "The total amount, calculated as a sum of amounts for all inventory issue operations included in this issue document.")
  ...
  public InventoryIssueDto controlAmount(Double controlAmount) {
  ...
  **/
  ...
  public InventoryIssueDto issueLines(List<InventoryIssueLineDto> issueLines) {
    this.issueLines = issueLines;
    return this;
  }

  public InventoryIssueDto addIssueLinesItem(InventoryIssueLineDto issueLinesItem) {
  ...
  **/
  ...
  public void setIssueLines(List<InventoryIssueLineDto> issueLines) {
    this.issueLines = issueLines;
  }

  public InventoryIssueDto referenceNumber(String referenceNumber) {
  ...
  **/
  ...
  public InventoryIssueDto status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InventoryIssueDto hold(Boolean hold) {
    this.hold = hold;
    return this;
  }
  ...
  **/
  ...
  public InventoryIssueDto date(LocalDateTime date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public InventoryIssueDto postPeriod(String postPeriod) {
  ...
  **/
  ...
  public InventoryIssueDto externalReference(String externalReference) {
  ...
  **/
  ...
  public InventoryIssueDto description(String description) {
  ...
  **/
  ...
  public InventoryIssueDto totalQuantity(Double totalQuantity) {
  ...
  **/
  ...
  public InventoryIssueDto controlQuantity(Double controlQuantity) {
  ...
  **/
  ...
  public InventoryIssueDto batchNumber(String batchNumber) {
  ...
  **/
  ...
  public InventoryIssueDto lastModifiedDateTime(LocalDateTime lastModifiedDateTime) {
  ...
  **/
  ...
  public InventoryIssueDto branchNumber(BranchNumberDto branchNumber) {
  ...
  **/
  ...
  public InventoryIssueDto attachments(List<AttachmentDto> attachments) {
    this.attachments = attachments;
    return this;
  }

  public InventoryIssueDto addAttachmentsItem(AttachmentDto attachmentsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InventoryIssueDto inventoryIssueDto = (InventoryIssueDto) o;
    return Objects.equals(this.totalAmount, inventoryIssueDto.totalAmount) &&
        Objects.equals(this.controlAmount, inventoryIssueDto.controlAmount) &&
        Objects.equals(this.issueLines, inventoryIssueDto.issueLines) &&
        Objects.equals(this.referenceNumber, inventoryIssueDto.referenceNumber) &&
        Objects.equals(this.status, inventoryIssueDto.status) &&
        Objects.equals(this.hold, inventoryIssueDto.hold) &&
        Objects.equals(this.date, inventoryIssueDto.date) &&
        Objects.equals(this.postPeriod, inventoryIssueDto.postPeriod) &&
        Objects.equals(this.externalReference, inventoryIssueDto.externalReference) &&
        Objects.equals(this.description, inventoryIssueDto.description) &&
        Objects.equals(this.totalQuantity, inventoryIssueDto.totalQuantity) &&
        Objects.equals(this.controlQuantity, inventoryIssueDto.controlQuantity) &&
        Objects.equals(this.batchNumber, inventoryIssueDto.batchNumber) &&
        Objects.equals(this.lastModifiedDateTime, inventoryIssueDto.lastModifiedDateTime) &&
        Objects.equals(this.branchNumber, inventoryIssueDto.branchNumber) &&
        Objects.equals(this.attachments, inventoryIssueDto.attachments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalAmount, controlAmount, issueLines, referenceNumber, status, hold, date, postPeriod, externalReference, description, totalQuantity, controlQuantity, batchNumber, lastModifiedDateTime, branchNumber, attachments);
  }
  ...
  public String toString() {
    ...
    sb.append("class InventoryIssueDto {\n");
